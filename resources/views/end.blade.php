...
<body class="bg-black w-screen h-screen flex justify-center items-center">
    ...
    <h1 class="text-3xl font-semibold">تسجيل نهاية الدوام</h1>
    <form action={{ route('checkOut') }} method="POST" class="w-full h-60 flex flex-col justify-center my-5">
        @csrf
        ...
        <input type="submit" value="تسجيل انتهاء دوام" class="w-[90%] h-10 border rounded-lg px-3 bg-slate-800 text-white  my-5">
    </form>
    <a href={{ route('welcome') }} class="underline text-lime-950 text-xl" >تسجيل بداية الدوام</a>
    </div>
</body>
</html>